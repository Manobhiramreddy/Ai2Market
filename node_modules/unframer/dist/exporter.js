...
async function bundle({ config, cwd: out = '', watch = false, signal = undefined, metafile = false, }) {
    ...
    async function rebuild() {
        ...
        const outFiles = buildResult.outputFiles
            ...
            .filter(Boolean)
            .concat([
            ...(metafile ? [path_1.default.resolve(out, 'meta.json')] : []),
    ...
    console.log();
    console.log(picocolors_1.default.cyan(picocolors_1.default.bold('How to use the Framer components')));
    console.log();
    console.log(picocolors_1.default.green('✓') +
        ' Your components are exported to ' +
        picocolors_1.default.yellow(outDirForExample) +
        ' folder');
    console.log();
    console.log(picocolors_1.default.dim('Each component has a ') +
        picocolors_1.default.cyan('.Responsive') +
        picocolors_1.default.dim(' variant that allows you to'));
    console.log(picocolors_1.default.dim('specify different variants for different breakpoints.'));
    if (exampleCode) {
        console.log();
        console.log(picocolors_1.default.magenta('You can use the components like this:'));
        console.log(picocolors_1.default.dim('(try copy pasting the code below into your React app)'));
        console.log();
    ...
    console.log(picocolors_1.default.yellow('⚠') +
        ...
        picocolors_1.default.cyan('styles.css') +
        ' file to include');
    console.log('   the necessary styles for the components.');
    console.log();
    console.log(picocolors_1.default.dim('To style components you can pass a ') +
        picocolors_1.default.cyan('style') +
        picocolors_1.default.dim(' or ') +
        picocolors_1.default.cyan('className') +
        picocolors_1.default.dim(' prop'));
    console.log();
    console.log(picocolors_1.default.dim('Read more on GitHub: ') +
        picocolors_1.default.underline(picocolors_1.default.blue('https://github.com/remorses/unframer')));
    console.log();
...
async function createExampleComponentCode({ outDir, config, }) {
    ...
    if (!instances?.length) {
        ...
        const imports = componentNames.map((name) => {
            return `import ${(0, typescript_js_1.componentCamelCase)(name)} from './${outDirForExample}/${name}'`;
        });
        const jsx = componentNames.map((name) => {
            return `<${(0, typescript_js_1.componentCamelCase)(name)}.Responsive />`;
        });
